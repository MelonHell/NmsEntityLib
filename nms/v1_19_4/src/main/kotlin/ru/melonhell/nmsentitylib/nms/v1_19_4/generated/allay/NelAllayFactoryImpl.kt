 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.allay
...
class NelAllayFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelAllayNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ALLAY
}