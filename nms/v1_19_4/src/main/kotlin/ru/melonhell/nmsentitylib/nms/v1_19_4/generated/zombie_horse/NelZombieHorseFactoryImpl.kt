 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.zombie_horse
...
@Component
class NelZombieHorseFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelZombieHorseNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ZOMBIE_HORSE
}