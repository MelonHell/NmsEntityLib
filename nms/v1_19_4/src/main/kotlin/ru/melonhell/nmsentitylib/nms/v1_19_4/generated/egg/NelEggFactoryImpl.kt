 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.egg
...
class NelEggFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelEggNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.EGG
}