 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.spider
...
class NelSpiderFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelSpiderNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.SPIDER
}