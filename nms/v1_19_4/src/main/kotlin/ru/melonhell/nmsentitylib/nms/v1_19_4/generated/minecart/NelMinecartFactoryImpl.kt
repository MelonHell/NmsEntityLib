 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.minecart
...
class NelMinecartFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelMinecartNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.MINECART
}