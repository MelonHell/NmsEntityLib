 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.dolphin
...
class NelDolphinFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelDolphinNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.DOLPHIN
}