 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.zoglin
...
class NelZoglinFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelZoglinNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ZOGLIN
}