 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.mooshroom
...
class NelMooshroomFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelMooshroomNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.MUSHROOM_COW
}