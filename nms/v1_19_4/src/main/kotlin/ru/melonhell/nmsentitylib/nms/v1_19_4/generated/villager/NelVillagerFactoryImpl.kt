 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.villager
...
class NelVillagerFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelVillagerNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.VILLAGER
}