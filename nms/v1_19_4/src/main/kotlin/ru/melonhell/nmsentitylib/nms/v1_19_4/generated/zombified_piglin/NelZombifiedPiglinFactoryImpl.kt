 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.zombified_piglin
...
@Component
class NelZombifiedPiglinFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelZombifiedPiglinNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ZOMBIFIED_PIGLIN
}