 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.tnt
...
class NelTntFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelTntNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.PRIMED_TNT
}