 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.wolf
...
class NelWolfFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelWolfNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.WOLF
}