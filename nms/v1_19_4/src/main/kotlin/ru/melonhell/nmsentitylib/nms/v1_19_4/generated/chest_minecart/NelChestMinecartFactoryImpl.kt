 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.chest_minecart
...
@Component
class NelChestMinecartFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelChestMinecartNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.MINECART_CHEST
}