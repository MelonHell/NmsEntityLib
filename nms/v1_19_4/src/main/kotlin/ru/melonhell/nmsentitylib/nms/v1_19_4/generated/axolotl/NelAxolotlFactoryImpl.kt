 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.axolotl
...
class NelAxolotlFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelAxolotlNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.AXOLOTL
}