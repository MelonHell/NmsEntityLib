 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.bee
...
class NelBeeFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelBeeNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.BEE
}