 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.trident
...
class NelTridentFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelTridentNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.TRIDENT
}