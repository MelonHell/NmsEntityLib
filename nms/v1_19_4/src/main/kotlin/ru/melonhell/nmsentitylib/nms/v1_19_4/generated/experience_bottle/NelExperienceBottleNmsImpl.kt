...
class NelExperienceBottleNmsImpl(
    world: Level,
    x: Double,
    y: Double,
    z: Double,
...
) : ThrownExperienceBottle(EntityType.EXPERIENCE_BOTTLE, world), NelEntityNms {
    ...
    private val bukkit = NelExperienceBottleBukkitImpl(this)
