 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.wither
...
class NelWitherFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelWitherNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.WITHER
}