 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.llama_spit
...
class NelLlamaSpitNmsImpl(
...
) : LlamaSpit(EntityType.LLAMA_SPIT, world), NelEntityNms {
    ...
    private val bukkit = NelLlamaSpitBukkitImpl(this)
