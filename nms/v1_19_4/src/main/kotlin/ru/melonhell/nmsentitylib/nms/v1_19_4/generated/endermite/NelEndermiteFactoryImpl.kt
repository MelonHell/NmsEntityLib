 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.endermite
...
class NelEndermiteFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelEndermiteNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ENDERMITE
}