 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.skeleton_horse
...
@Component
class NelSkeletonHorseFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelSkeletonHorseNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.SKELETON_HORSE
}