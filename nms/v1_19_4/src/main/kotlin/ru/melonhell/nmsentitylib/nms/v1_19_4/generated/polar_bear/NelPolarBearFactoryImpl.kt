 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.polar_bear
...
class NelPolarBearFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelPolarBearNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.POLAR_BEAR
}