 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.tropical_fish
...
@Component
class NelTropicalFishFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelTropicalFishNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.TROPICAL_FISH
}