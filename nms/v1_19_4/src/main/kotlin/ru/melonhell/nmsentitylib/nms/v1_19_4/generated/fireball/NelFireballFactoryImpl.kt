 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.fireball
...
class NelFireballFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelFireballNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.FIREBALL
}