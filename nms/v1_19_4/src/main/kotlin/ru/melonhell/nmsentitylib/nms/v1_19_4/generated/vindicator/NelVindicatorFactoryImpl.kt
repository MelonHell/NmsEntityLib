 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.vindicator
...
@Component
class NelVindicatorFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelVindicatorNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.VINDICATOR
}