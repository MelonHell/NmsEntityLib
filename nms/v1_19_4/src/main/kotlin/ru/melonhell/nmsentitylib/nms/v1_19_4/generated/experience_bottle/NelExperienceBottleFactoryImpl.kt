 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.experience_bottle
...
@Component
class NelExperienceBottleFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelExperienceBottleNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.THROWN_EXP_BOTTLE
}