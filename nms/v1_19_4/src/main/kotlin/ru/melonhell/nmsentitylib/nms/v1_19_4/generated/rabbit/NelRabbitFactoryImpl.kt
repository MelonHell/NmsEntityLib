 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.rabbit
...
class NelRabbitFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelRabbitNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.RABBIT
}