 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.glow_squid
...
class NelGlowSquidFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelGlowSquidNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.GLOW_SQUID
}