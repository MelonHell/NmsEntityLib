 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.ender_dragon
...
@Component
class NelEnderDragonFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelEnderDragonNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ENDER_DRAGON
}