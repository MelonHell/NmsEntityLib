 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.fishing_bobber
...
@Component
class NelFishingBobberFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelFishingBobberNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.FISHING_HOOK
}