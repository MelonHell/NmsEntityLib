 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.dragon_fireball
...
@Component
class NelDragonFireballFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelDragonFireballNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.DRAGON_FIREBALL
}