...
@Component
class NelCommandBlockMinecartFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelCommandBlockMinecartNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.MINECART_COMMAND
}