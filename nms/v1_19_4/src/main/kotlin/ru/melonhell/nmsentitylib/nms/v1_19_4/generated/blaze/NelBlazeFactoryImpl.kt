 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.blaze
...
class NelBlazeFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelBlazeNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.BLAZE
}