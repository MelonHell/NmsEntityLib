 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.furnace_minecart
...
@Component
class NelFurnaceMinecartFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelFurnaceMinecartNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.MINECART_FURNACE
}