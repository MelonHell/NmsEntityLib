 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.arrow
...
class NelArrowFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelArrowNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ARROW
}