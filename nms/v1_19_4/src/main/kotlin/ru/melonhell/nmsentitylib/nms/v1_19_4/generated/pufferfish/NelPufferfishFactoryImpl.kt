 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.pufferfish
...
@Component
class NelPufferfishFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelPufferfishNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.PUFFERFISH
}