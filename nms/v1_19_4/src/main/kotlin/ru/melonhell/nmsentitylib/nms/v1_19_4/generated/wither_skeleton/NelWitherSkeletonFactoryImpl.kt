 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.wither_skeleton
...
@Component
class NelWitherSkeletonFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelWitherSkeletonNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.WITHER_SKELETON
}