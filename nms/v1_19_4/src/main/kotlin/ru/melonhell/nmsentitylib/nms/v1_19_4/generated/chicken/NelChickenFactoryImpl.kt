 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_4.generated.chicken
...
class NelChickenFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelChickenNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.CHICKEN
}