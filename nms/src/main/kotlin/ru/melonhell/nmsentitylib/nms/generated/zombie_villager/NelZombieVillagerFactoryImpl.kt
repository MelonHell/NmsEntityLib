 ...
 */
package ru.melonhell.nmsentitylib.nms.generated.zombie_villager
...
@Component
class NelZombieVillagerFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelZombieVillagerNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ZOMBIE_VILLAGER
}