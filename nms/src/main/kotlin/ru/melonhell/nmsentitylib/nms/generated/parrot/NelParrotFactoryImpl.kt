 ...
 */
package ru.melonhell.nmsentitylib.nms.generated.parrot
...
class NelParrotFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelParrotNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.PARROT
}