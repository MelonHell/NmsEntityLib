 ...
 */
package ru.melonhell.nmsentitylib.nms.generated.phantom
...
class NelPhantomFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelPhantomNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.PHANTOM
}