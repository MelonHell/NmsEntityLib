 ...
 */
package ru.melonhell.nmsentitylib.nms.generated.experience_orb
...
@Component
class NelExperienceOrbFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelExperienceOrbNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.EXPERIENCE_ORB
}