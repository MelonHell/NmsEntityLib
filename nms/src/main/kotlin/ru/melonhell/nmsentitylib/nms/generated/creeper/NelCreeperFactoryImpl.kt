 ...
 */
package ru.melonhell.nmsentitylib.nms.generated.creeper
...
class NelCreeperFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelCreeperNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.CREEPER
}