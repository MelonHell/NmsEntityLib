 ...
 */
package ru.melonhell.nmsentitylib.nms.generated.boat
...
class NelBoatFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelBoatNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.BOAT
}