 ...
 */
package ru.melonhell.nmsentitylib.nms.generated.trader_llama
...
@Component
class NelTraderLlamaFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelTraderLlamaNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.TRADER_LLAMA
}