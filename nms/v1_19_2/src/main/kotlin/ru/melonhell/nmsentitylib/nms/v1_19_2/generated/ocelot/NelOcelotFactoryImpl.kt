 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.ocelot
...
class NelOcelotFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelOcelotNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.OCELOT
}