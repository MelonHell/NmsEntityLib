 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.wandering_trader
...
class NelWanderingTraderNmsImpl(
    world: Level,
    x: Double,
    y: Double,
    z: Double,
...
) : WanderingTrader(EntityType.WANDERING_TRADER, world), NelEntityNms {
    ...
    private val bukkit = NelWanderingTraderBukkitImpl(this)
