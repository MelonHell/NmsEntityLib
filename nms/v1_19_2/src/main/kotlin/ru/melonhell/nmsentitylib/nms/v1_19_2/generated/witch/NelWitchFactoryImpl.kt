 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.witch
...
class NelWitchFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelWitchNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.WITCH
}