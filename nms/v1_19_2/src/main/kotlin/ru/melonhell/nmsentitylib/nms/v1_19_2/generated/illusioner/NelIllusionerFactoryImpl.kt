 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.illusioner
...
@Component
class NelIllusionerFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelIllusionerNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ILLUSIONER
}