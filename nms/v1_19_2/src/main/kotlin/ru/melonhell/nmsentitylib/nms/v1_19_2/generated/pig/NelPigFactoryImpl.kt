 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.pig
...
class NelPigFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelPigNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.PIG
}