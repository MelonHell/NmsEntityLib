 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.cat
...
class NelCatFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelCatNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.CAT
}