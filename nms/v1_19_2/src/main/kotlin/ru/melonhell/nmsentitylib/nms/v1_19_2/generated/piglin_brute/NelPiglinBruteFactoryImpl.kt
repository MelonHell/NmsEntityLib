 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.piglin_brute
...
@Component
class NelPiglinBruteFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelPiglinBruteNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.PIGLIN_BRUTE
}