 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.pillager
...
class NelPillagerFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelPillagerNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.PILLAGER
}