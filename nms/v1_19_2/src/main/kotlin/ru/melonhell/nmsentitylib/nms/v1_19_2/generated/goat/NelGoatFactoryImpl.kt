 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.goat
...
class NelGoatFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelGoatNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.GOAT
}