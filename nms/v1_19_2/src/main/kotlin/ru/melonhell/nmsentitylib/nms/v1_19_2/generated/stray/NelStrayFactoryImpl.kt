 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.stray
...
class NelStrayFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelStrayNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.STRAY
}