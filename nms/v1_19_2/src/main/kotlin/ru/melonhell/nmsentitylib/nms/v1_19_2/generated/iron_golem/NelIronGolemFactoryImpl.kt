 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.iron_golem
...
class NelIronGolemFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelIronGolemNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.IRON_GOLEM
}