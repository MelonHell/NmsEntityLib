 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.frog
...
class NelFrogFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelFrogNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.FROG
}