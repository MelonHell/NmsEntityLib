 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.spectral_arrow
...
@Component
class NelSpectralArrowFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelSpectralArrowNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.SPECTRAL_ARROW
}