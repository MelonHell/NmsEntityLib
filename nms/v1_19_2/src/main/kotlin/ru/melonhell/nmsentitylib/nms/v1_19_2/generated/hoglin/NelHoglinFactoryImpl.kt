 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.hoglin
...
class NelHoglinFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelHoglinNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.HOGLIN
}