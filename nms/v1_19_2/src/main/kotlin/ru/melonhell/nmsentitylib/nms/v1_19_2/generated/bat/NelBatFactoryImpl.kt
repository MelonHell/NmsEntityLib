 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.bat
...
class NelBatFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelBatNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.BAT
}