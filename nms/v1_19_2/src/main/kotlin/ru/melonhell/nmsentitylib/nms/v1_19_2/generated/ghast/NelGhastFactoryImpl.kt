 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.ghast
...
class NelGhastFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelGhastNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.GHAST
}