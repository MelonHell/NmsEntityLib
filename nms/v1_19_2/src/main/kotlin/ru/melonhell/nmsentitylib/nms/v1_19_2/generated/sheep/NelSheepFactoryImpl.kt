 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.sheep
...
class NelSheepFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelSheepNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.SHEEP
}