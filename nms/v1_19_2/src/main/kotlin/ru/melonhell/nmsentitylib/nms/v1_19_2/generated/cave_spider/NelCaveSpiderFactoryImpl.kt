 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.cave_spider
...
@Component
class NelCaveSpiderFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelCaveSpiderNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.CAVE_SPIDER
}