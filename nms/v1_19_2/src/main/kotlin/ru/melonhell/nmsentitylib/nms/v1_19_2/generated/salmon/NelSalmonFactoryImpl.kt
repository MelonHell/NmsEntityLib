 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.salmon
...
class NelSalmonFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelSalmonNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.SALMON
}