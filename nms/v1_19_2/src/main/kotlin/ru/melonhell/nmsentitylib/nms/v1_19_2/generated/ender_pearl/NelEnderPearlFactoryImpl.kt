 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.ender_pearl
...
@Component
class NelEnderPearlFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelEnderPearlNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.ENDER_PEARL
}