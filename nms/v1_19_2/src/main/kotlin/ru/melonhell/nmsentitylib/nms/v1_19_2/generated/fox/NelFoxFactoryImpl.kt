 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.fox
...
class NelFoxFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelFoxNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.FOX
}