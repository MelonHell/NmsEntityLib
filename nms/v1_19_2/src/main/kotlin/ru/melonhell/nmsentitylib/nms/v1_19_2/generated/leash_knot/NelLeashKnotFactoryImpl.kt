 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.leash_knot
...
class NelLeashKnotFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelLeashKnotNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.LEASH_HITCH
}