...
class NelCommandBlockMinecartNmsImpl(
    world: Level,
    x: Double,
    y: Double,
    z: Double,
...
) : MinecartCommandBlock(EntityType.COMMAND_BLOCK_MINECART, world), NelEntityNms {
    ...
    private val bukkit = NelCommandBlockMinecartBukkitImpl(this)
