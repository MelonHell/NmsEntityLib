 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.turtle
...
class NelTurtleFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelTurtleNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.TURTLE
}