 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.small_fireball
...
@Component
class NelSmallFireballFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelSmallFireballNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.SMALL_FIREBALL
}