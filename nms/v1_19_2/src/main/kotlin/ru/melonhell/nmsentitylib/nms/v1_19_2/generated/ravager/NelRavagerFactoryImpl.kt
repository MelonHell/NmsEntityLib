 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.ravager
...
class NelRavagerFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelRavagerNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.RAVAGER
}