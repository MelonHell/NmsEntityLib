 ...
 */
package ru.melonhell.nmsentitylib.nms.v1_19_2.generated.strider
...
class NelStriderFactoryImpl(
    ...
    override fun createNms(
        ...
        y: Double,
        z: Double
    ) = NelStriderNmsImpl(nmsWorld, x, y, z, saveService, schedulerUtils)

    override val entityType = EntityType.STRIDER
}