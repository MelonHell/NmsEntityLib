...
class Nel%entity_name_camel%NmsImpl(
    world: Level,
    x: Double,
    y: Double,
    z: Double,
...
) : %nms_class_name%(EntityType.%nms_entity_type%, world), NelEntityNms {
    ...
    private val bukkit = Nel%entity_name_camel%BukkitImpl(this)
